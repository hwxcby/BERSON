...
def train(args, train_dataset, model, tokenizer):
    ...
    train_dataloader = DataLoader(train_dataset, sampler=train_sampler, batch_size=args.train_batch_size, collate_fn=preprocess)
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            #  batch: all_input_ids, all_attention_mask, all_token_type_ids, all_position_ids, all_order, all_cls_ids, all_mask_cls, all_num_sen
...
def evaluate(args, eval_dataset, model, tokenizer, prefix=""):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating"):
            ...
            true_num = batch[4].view(-1)  # true order
            tru = tru[:true_num]
            truth.append(tru)
            ...
            with torch.no_grad():
                ...
                if len(tru) == 1:
                    ...
                    pred = beam_search_pointer(args, model, input_ids=batch[0], attention_mask=batch[1], token_type_ids=batch[2],
                        ...
                        ground_truth=batch[7], mask_cls=batch[8], pairwise_labels=batch[9], cuda=args.cuda_ip)
